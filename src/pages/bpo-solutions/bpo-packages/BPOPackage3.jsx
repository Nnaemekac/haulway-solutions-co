...
import Package3 from "../../../assets/images/bpo-packages/lg-package3.jpg";
import Dropdown from '../components/bpo-package3/Dropdown';
...
const BPOPackage3 = () => {
    return (
        <section className='xui-lg-pt-8 xui-pt-7 xui-pb-3 xui-container'>
            ...
            <BPONavigation routeBack='/bpo/solutions/package/2' route='/bpo/solutions/package/4' isLeftIcon={true} isRightIcon={true} />
