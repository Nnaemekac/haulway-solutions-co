...
import Package4 from "../../../assets/images/bpo-packages/lg-package4.jpg";
import Dropdown from '../components/bpo-package4/Dropdown';
        ...
        <section className='xui-lg-pt-8 xui-pt-7 xui-pb-3 xui-container'>
            <div className='xui-row xui-mt-3-half'>
                <div className='xui-lg-col-5 xui-col-12'>
                    <h3 className='xui-font-sz-120 xui-font-w-500'>Enterprise Solution Package</h3>
                ...
                <div className='xui-lg-col-7 xui-col-12 xui-lg-pl-1 xui-pl-none xui-lg-mt-none xui-mt-1-half  xui-pos-relative bpo-image'>
                    <img className='xui-w-fluid-100 xui-h-300 xui-bdr-rad-1 xui-pos-sticky' src={Package4} alt="" />
                    <p className='xui-font-sz-100 xui-opacity-8 xui-line-height-1-half xui-mt-1 xui-lg-w-fluid-90 xui-w-fluid-100'>Providing tailored BPO packages for enterprise businesses that optimize complex operations, drive efficiency, and support large-scale growth. Our solutions offer strategic outsourcing to manage intricate processes, enhance productivity, and ensure seamless integration with your existing systems, empowering your organization to focus on strategic initiatives.</p>
            ...
            <BPONavigation routeBack='/bpo/solutions/package/3' isLeftIcon={true} />
