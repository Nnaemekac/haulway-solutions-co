...
const OurSolutions = () => {
  ...
  return (
    ...
    <div className="xui-pt-1 xui-lg-pb-5 xui-pb-5 xui-container">
        <h3 data-aos="fade-in" data-aos-duration="800" class="xui-font-sz-200 xui-text-center break xui-font-w-500 xui-line-height-2-half xui-font-9">Our Solutions include:</h3>
        <div className="xui-d-grid xui-lg-grid-col-3 xui-grid-col-1 xui-grid-gap-1 xui-mt-1">
            <Link to='/solutions/ecommerce-solutions' className="bpo xui-d-flex xui-flex-jc-center xui-flex-ai-center">
                <span className="xui-w-40 xui-h-40 xui-d-flex xui-flex-ai-center xui-flex-jc-center">
                    <ShoppingCart size="19" color="#000" />
                </span>
                <p className="xui-font-sz-90 xui-opacity-8 xui-pl-1">Ecommerce solutions</p>
            </Link>
            <Link to='/solutions/agrotech-solutions' className="bpo xui-d-flex xui-flex-jc-center xui-flex-ai-center">
                <span className="xui-w-40 xui-h-40 xui-d-flex xui-flex-ai-center xui-flex-jc-center">
                    <Code size="19px" color="#000" />
                </span>
                <p className="xui-font-sz-90 xui-opacity-8 xui-pl-1">Agrotech solutions</p>
            </Link>
            <Link to='/solutions/custom-software-solutions' className="bpo xui-d-flex xui-flex-jc-center xui-flex-ai-center">
                <span className="xui-w-40 xui-h-40 xui-d-flex xui-flex-ai-center xui-flex-jc-center">
                    <Computing size="19" color="#000" />
                </span>
                <p className="xui-font-sz-90 xui-opacity-8 xui-pl-1">Custom software solutions</p>
            </Link>
        </div>
