...
const Header = () => {
    return (
        <div className='xui-py-3 xui-text-center'>
            <span className='xui-d-inline-block xui-py-1 xui-px-1-half xui-bdr-white xui-bdr-s-solid xui-bdr-w-1 xui-bdr-rad-2 xui-lg-font-sz-95 xui-font-sz-85'>IT Services</span>
