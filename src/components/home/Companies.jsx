...
const Companies = () => {
    return (
        <section className='xui-py-3'>
            <h3 className='xui-font-sz-150 xui-font-w-500 xui-text-center'>Companies That Trust Us</h3>
            <div className='xui-mt-2-half bg-[#1E1E1E] xui-container xui-py-1 xui-d-flex xui-flex-ai-center xui-flex-jc-space-between'>
                <img className='xui-img-150' src={Haulway} alt="" />
                <img className='xui-img-80' src={SunflowerPantry} alt="" />
                <img className='xui-img-150' src={AmanduSkincare} alt="" />
                <img className='xui-img-150' src={MyCut} alt="" />
                <img className='xui-img-150' src={Begorah} alt="" />
            </div>
        </section>
    );
};
