...
const WhoWeAre = () => {
    return (
        <section className='xui-py-3 xui-container'>
            <SectionComponent subheading='WHO WE ARE' heading='A UK-Based Company Delivering Cost-Effective, Fully Managed Talent' />
                    ...
                    <div className='xui-d-grid xui-lg-grid-col-2 xui-grid-col-1 xui-grid-gap-1'>
                        <div className='xui-pt-1 xui-px-1 xui-pb-2 xui-bdr-rad-1 bg-[#1E1E1E]'>
                            <div className='xui-d-flex xui-flex-ai-center xui-grid-gap-1'>
                                <span className='xui-w-35 xui-h-35 xui-bdr-rad-circle xui-d-flex xui-flex-jc-center xui-flex-ai-center gradient-btn'><Harness /></span>
                                <h3 className='xui-font-sz-110 xui-font-w-500'>DUNS Number: 231613614</h3>
                            </div>
                            <p className='xui-font-sz-95 xui-line-height-1-half xui-mt-1'>We are a UK-registered business providing managed outsourcing teams in Nigeria with structured staffing & UK contract protection.</p>
                        </div>
                        <div className='xui-pt-1 xui-px-1 xui-pb-2 xui-bdr-rad-1 bg-[#1E1E1E]'>
                            <div className='xui-d-flex xui-flex-ai-center xui-grid-gap-1'>
                                <span className='xui-w-35 xui-h-35 xui-bdr-rad-circle xui-d-flex xui-flex-jc-center xui-flex-ai-center gradient-btn'><LocationStar /></span>
                                <h3 className='xui-font-sz-110 xui-font-w-500'>Quality Teams, Lower Costs</h3>
                            </div>
                            <p className='xui-font-sz-95 xui-line-height-1-half xui-mt-1'>Offering structured outsourcing teams in Nigeria, ensuring UK-level quality with 60%+ cost savings—no freelancers, just full-time professionals.</p>
                        </div>
                        <div className='xui-pt-1 xui-px-1 xui-pb-2 xui-bdr-rad-1 bg-[#1E1E1E]'>
                            <div className='xui-d-flex xui-flex-ai-center xui-grid-gap-1'>
                                <span className='xui-w-35 xui-h-35 xui-bdr-rad-circle xui-d-flex xui-flex-jc-center xui-flex-ai-center gradient-btn'><LogosWorkos /></span>
                                <h3 className='xui-font-sz-110 xui-font-w-500'>Dedicated Account Managers</h3>
                            </div>
                            <p className='xui-font-sz-95 xui-line-height-1-half xui-mt-1'>We provide dedicated account managers for direct reporting, full workforce supervision, & seamless team coordination, ensuring efficiency & accountability.</p>
                        </div>
                        <div className='xui-pt-1 xui-px-1 xui-pb-2 xui-bdr-rad-1 bg-[#1E1E1E]'>
                            <div className='xui-d-flex xui-flex-ai-center xui-grid-gap-1'>
                                <span className='xui-w-35 xui-h-35 xui-bdr-rad-circle xui-d-flex xui-flex-jc-center xui-flex-ai-center gradient-btn'><Eclipse /></span>
                                <h3 className='xui-font-sz-110 xui-font-w-500'>ISO & Compliance Standards</h3>
                            </div>
                            <p className='xui-font-sz-95 xui-line-height-1-half xui-mt-1'>We ensure secure, reliable, and scalable workforce solutions that meet ISO and compliance standards, guaranteeing quality and operational excellence.</p>
                        </div>
                    </div>
                </div>
            </div>
