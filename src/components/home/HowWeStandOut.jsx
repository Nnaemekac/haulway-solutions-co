                    ...
                    <div className='xui-d-grid xui-lg-grid-col-2 xui-grid-col-1 xui-grid-gap-1'>
                        <div className='xui-pt-1 xui-px-1 xui-pb-2 xui-bdr-rad-1 gradient-btn'>
                            <div className='xui-d-flex xui-flex-ai-center xui-grid-gap-1'>
                                <span className='xui-w-35 xui-h-35 xui-bdr-rad-circle xui-d-flex xui-flex-jc-center xui-flex-ai-center gradient-btn'><Shield /></span>
                                <h3 className='xui-font-sz-110 xui-font-w-500'>Legal Protection:</h3>
                            </div>
                            <p className='xui-font-sz-95 xui-line-height-1-half xui-mt-1'>As a UK-registered business with a DUNS number, we offer robust legal protection and peace of mind through our comprehensive compliance standards.</p>
                        </div>
                        <div className='xui-pt-1 xui-px-1 xui-pb-2 xui-bdr-rad-1 gradient-btn'>
                            <div className='xui-d-flex xui-flex-ai-center xui-grid-gap-1'>
                                <span className='xui-w-35 xui-h-35 xui-bdr-rad-circle xui-d-flex xui-flex-jc-center xui-flex-ai-center gradient-btn'><Clock /></span>
                                <h3 className='xui-font-sz-110 xui-font-w-500'>24/7 Support</h3>
                            </div>
                            <p className='xui-font-sz-95 xui-line-height-1-half xui-mt-1'>With 24/7 support and dedicated account managers, we deliver real-time updates and performance tracking to keep you informed every step of the way.</p>
                        </div>
                        <div className='xui-pt-1 xui-px-1 xui-pb-2 xui-bdr-rad-1 gradient-btn'>
                            <div className='xui-d-flex xui-flex-ai-center xui-grid-gap-1'>
                                <span className='xui-w-35 xui-h-35 xui-bdr-rad-circle xui-d-flex xui-flex-jc-center xui-flex-ai-center gradient-btn'><HashNode /></span>
                                <h3 className='xui-font-sz-110 xui-font-w-500'>Better Pricing</h3>
                            </div>
                            <p className='xui-font-sz-95 xui-line-height-1-half xui-mt-1'>Save up to 60% on staffing costs while benefiting from our streamlined team management and dedicated support services.</p>
                        </div>
                        <div className='xui-pt-1 xui-px-1 xui-pb-2 xui-bdr-rad-1 gradient-btn'>
                            <div className='xui-d-flex xui-flex-ai-center xui-grid-gap-1'>
                                <span className='xui-w-35 xui-h-35 xui-bdr-rad-circle xui-d-flex xui-flex-jc-center xui-flex-ai-center gradient-btn'><RockyLinux /></span>
                                <h3 className='xui-font-sz-110 xui-font-w-500'>Fully Supervised Staff</h3>
                            </div>
                            <p className='xui-font-sz-95 xui-line-height-1-half xui-mt-1'>We maintain an in-person workforce with structured management for accountability, seamless coordination, and exceptional performance.</p>
                        </div>
                    </div>
                </div>
            </div>
