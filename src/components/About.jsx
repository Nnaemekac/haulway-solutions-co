...
export default function About(){
    return(
        <>
            <section id='about' className=" xui-container xui-lg-py-4 xui-py-2">
                <div className='xui-row xui-flex-ai-center'>
                    <div className='xui-lg-col-7 xui-col-12'>
                        <p className='xui-font-sz-80'>Who we are</p>
                        <h1 className="xui-lg-font-sz-300 xui-font-sz-250 font-spaceGrotesk">Grascope Industries Ltd</h1>
                        <p className="xui-font-sz-80 xui-opacity-8 xui-line-height-1-half xui-lg-w-fluid-80 xui-w-fluid-100 xui-mt-half">Grascope Industries Ltd is a dynamic conglomerate dedicated to driving innovation and entrepreneurship across sectors. With a robust portfolio of companies under our wing, we're at the forefront of shaping industries and creating lasting impact.</p>
                    </div>
