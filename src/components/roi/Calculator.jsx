...
const Calculator = () => {
  ...
  const positionOptions = [
    ...
    { 
      ...
      grascopeCostPerMonth: null // Will calculate based on input
    }
  ];
  ...
  const calculateROI = (data) => {
    ...
    if (selectedPosition.grascopeCostPerMonth) {
      // Use fixed monthly cost if available
      grascopeCostPerYear = selectedPosition.grascopeCostPerMonth * 12;
    } else {
      // Calculate based on savings percentage for "Other" positions
  ...
  const handleSecondStepSubmit = (fields) => {
    const calculatedROI = calculateROI(fields);
  ...
  return (
    <div className={`${step !== 2 && 'xui-max-w-900'} xui-w-fluid-100 xui-mx-auto`}>
            ...
            <form onSubmit={handleSubmit(handleFirstStepSubmit)} autoComplete="off" noValidate>
              <div className='xui-d-grid xui-lg-grid-col-2 xui-grid-col-1 xui-grid-gap-2'>
                ...
                <div className='form-section-form-grp'>
                  ...
                  <input type="tel" id="phoneNumber" className='xui-mt-1 xui-w-fluid-100 xui-h-70 xui-p-1-half xui-bdr-s-none xui-bdr-rad-half bg-[#1E1E1E] xui-text-white' placeholder="Phone Number" {...register("phoneNumber", { pattern: { value: /^[0-9]{10,15}$/, message: "Phone number must be 10–15 digits" } })} />
                  {errors.phoneNumber && (<p className="xui-form-error-msg">{errors.phoneNumber.message}</p>)}
                </div>
              </div>
              <button type="submit" className='xui-max-w-500 xui-w-fluid-100 xui-mx-auto padding-[1rem] gradient-btn xui-bdr-rad-2 xui-d-flex xui-flex-jc-center xui-mt-2'>
      ...
      {step === 2 && (
        <section className='xui-py-1-half bg-[#222222] xui-px-1-half xui-bdr-rad-half xui-mb-2'>
            <div className='xui-d-flex xui-flex-jc-space-between xui-flex-ai-center xui-grid-gap-1 xui-mt-half'>
                <span className='xui-cursor-pointer' onClick={() => setStep(1)}><ArrowLeft color='#FFF' /></span>
          ...
          <div className="form-section xui-mt-2">
            <form onSubmit={handleSubmit(handleSecondStepSubmit)} autoComplete="off" noValidate>
              <div className='form-section-form-grp'>
                ...
                <select id="hiringPosition" className='xui-w-fluid-100 xui-h-70 xui-mt-1 xui-p-1-half xui-bdr-white xui-bdr-w-1 xui-bdr-s-solid xui-bdr-rad-half xui-bg-transparent xui-text-white ' {...register("hiringPosition", { required: "This field is required" })}>
              ...
              <div className='xui-d-grid xui-grid-col-2 xui-grid-gap-2 xui-mt-2'>
                <div className='form-section-form-grp'>
                  ...
                  <div className='xui-pos-relative xui-mt-1'>
                    <div className="xui-w-60 xui-h-fluid-100 xui-pos-absolute left-[0]">
                        <select {...register('currency', { required: 'Currency is required' })} className="xui-w-fluid-100 xui-h-fluid-100 xui-pl-1-half xui-bg-transparent xui-font-w-600 xui-text-white" style={{outline: 'none', border: 'none'}}>
                            <option value="GBP">£</option>
                        </select>
                    </div>
                    <input type="number" id="currentCostMonth" placeholder="£0" className='xui-w-fluid-100 xui-h-70 xui-py-1-half xui-pl-5 xui-pr-1-half xui-bdr-white xui-bdr-w-1 xui-bdr-s-solid xui-bdr-rad-half xui-bg-transparent xui-text-white ' {...register("currentCostMonth", { required: "This field is required", min: { value: 0, message: "Value must be positive" }, valueAsNumber: true})} />
                  </div>
                ...
                <div className='form-section-form-grp'>
                  ...
                  <div className='xui-pos-relative xui-mt-1'>
                    ...
                    <input type="number" id="currentCostYear" placeholder="£0" className='xui-w-fluid-100 xui-h-70 xui-py-1-half xui-pl-5 xui-pr-1-half xui-bdr-white xui-bdr-w-1 xui-bdr-s-solid xui-bdr-rad-half xui-bg-transparent xui-text-white ' {...register("currentCostYear", { required: "This field is required", min: { value: 0, message: "Value must be positive" }, valueAsNumber: true})} />
                  </div>
                </div>
              </div>
              <div className='xui-d-flex xui-flex-jc-center xui-flex-gap-1 xui-mt-2'>
                <button type="submit" className='xui-max-w-500 xui-w-fluid-100 xui-mx-auto padding-[1rem] gradient-btn xui-bdr-rad-2 xui-d-flex xui-flex-jc-center xui-mt-2'>
                  <p className='xui-font-sz-95'>My ROI with Grascope</p>
                </button>
              </div>
            </form>
          </div>
      ...
      {step === 3 && roiData && (
        <section className='xui-py-1-half bg-[#222222] xui-px-1-half xui-bdr-rad-half xui-mb-2'>
            <div className='xui-d-flex xui-flex-jc-space-between xui-flex-ai-center xui-grid-gap-1 xui-mt-half'>
                <span className='xui-cursor-pointer' onClick={() => setStep(2)}><ArrowLeft color='#FFF' /></span>
            ...
            <div className="xui-mt-2">
                ...
                <div className='xui-d-flex xui-flex-ai-center xui-flex-jc-space-between'>
                    ...
                    <p className='xui-font-sz-120 xui-font-w-600'>{roiData.hiringPosition}</p>
                </div>
                <div className='xui-d-flex xui-flex-ai-center xui-flex-jc-space-between'>
                    <p className='xui-font-sz-110 xui-font-w-400'>Your Current Hiring Cost/year</p>
                    <p className='xui-font-sz-120 xui-font-w-600'>{roiData.currentCostYear}</p>
                </div>
                <div className='xui-d-flex xui-flex-ai-center xui-flex-jc-space-between'>
                    <p className='xui-font-sz-110 xui-font-w-400'>Your Hiring Cost with Grascope/year</p>
                    <p className='xui-font-sz-120 xui-font-w-600'>{roiData.grascopeCostYear}</p>
                </div>
                <div className='xui-d-flex xui-flex-ai-center xui-flex-jc-space-between'>
                    <p className='xui-font-sz-110 xui-font-w-400'>Total Savings/year</p>
                    <p className='xui-font-sz-120 xui-font-w-600'>{roiData.totalSavings}</p>
                </div>
                <div className='xui-d-flex xui-flex-ai-center xui-flex-jc-space-between'>
                    <p className='xui-font-sz-110 xui-font-w-400'>Percentage Saved</p>
                    <p className='xui-font-sz-120 xui-font-w-600'>{roiData.percentageSaved}</p>
                </div>
                </div>
            </div>
            <div className='xui-max-w-700 xui-w-fluid-100 xui-mx-auto xui-d-grid xui-lg-grid-col-2 xui-grid-col-1 xui-grid-gap-1 xui-mt-4'>
                <Link to="https://calendly.com/grascope" target="_blank" rel="noopener noreferrer" className='xui-w-fluid-100 xui-px-2 xui-py-1 gradient-btn xui-bdr-rad-half xui-text-dc-none xui-text-white xui-text-center'>Book a Demo</Link>
                <a href="/Grascope Brochure.pdf" target="_blank" rel="noopener noreferrer" className="xui-w-fluid-100 xui-px-2 xui-py-1 bg-gradient2 xui-bdr-rad-half xui-text-dc-none xui-text-white xui-text-center">See How It Works</a>
            </div>
        </section>
      )}
    </div>
